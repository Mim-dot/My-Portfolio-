...
const Projects = () => {
  ...
  <div className="modal-box bg-gradient-to-br w-full max-w-[1050px] from-blue-100 via-white to-blue-50 shadow-2xl border border-blue-200 rounded-xl mx-auto p-6">
    <form method="dialog">
    ...
    <div className="flex flex-col md:flex-row md:justify-between gap-6 mb-6">
      ...
      <div className="w-full md:w-[400px] flex-shrink-0">
        <img
          className="w-full md:h-[250px] rounded-xl shadow-md transition-transform duration-300 hover:scale-105 object-cover"
          src="https://i.ibb.co/zV6F2QP2/Screenshot-122.png"
          alt="Freelancer Marketplace"
        />
      </div>
    ...
    <div className="text-base text-gray-800 space-y-6 leading-relaxed">
      ...
      <div>
        ...
        <p>
          A modern freelance platform where users can post tasks, bid, message in real-time, and manage roles like admin,
      ...
      <div>
        ...
        <ul className="list-disc pl-6 text-gray-700">
          <li>Secure and dynamic authentication flow with role handling</li>
          <li>Responsive and adaptive layout for all screen sizes</li>
          <li>Seamless modal management and conditional rendering</li>
        </ul>
      </div>
...
<dialog id="modal_project2" className="modal text-left">
  <div className="modal-box bg-gradient-to-br w-full max-w-[1050px] from-green-100 via-white to-green-50 shadow-xl border border-green-200 rounded-xl mx-auto p-6">
    <form method="dialog">
      <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 text-gray-500 hover:text-red-500">
        ✕
      </button>
